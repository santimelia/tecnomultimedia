class Pantalla {
  constructor(p) {
    ...
    this.textos[1][0] = "El cohete- Ray Bradbury";
    ...
    this.textos[0][3] = "Aunque sus días eran iguales y aburridos.";
    ...
    this.textos[0][9] = "Gracias a la ayuda y dedicaion";
    ...
    this.textos[1][12] = "Muevete con las flechas y aprieta ENTER para disparar.";
    this.textos[0][13] = "";
    this.textos[1][13] = "";
    this.textos[0][14] = "Lamentablemente Bodoni murio.";
    this.textos[1][14] = "";
    this.textos[0][15] = "Bodoni debia elegir un camino.";
    this.textos[0][16] = "Bodoni enfrenta momentos de soledad y reflexión.";
    this.textos[1][16] = "Se cuestiona sobre el significado de su viaje y decide.";
